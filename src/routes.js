...
const real_time_pump_data   = lazy(() => import("views/real_time_pump_data/RealTimePumpData"));
...
const routesAndMenuItems = {
    ...
    }, 
    {
        ...
        exact    : true,
        redirect : true,
        to       : `${appRoot}/pump/addpump`,
        label    : "Pump",
        icon     : "grid-2",
        icon: "spinner",
        subs : [
            { path : "/add_pump", label : "Add Pump", component : pump.addpump },
